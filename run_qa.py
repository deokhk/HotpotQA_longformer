...
def main():
    ...
    if data_args.dataset_name is not None:
        ...
        if data_args.dataset_name == "hotpotqa":
            raw_datasets = load_hotpotqa()
        else:
    ...
    #
    training_args.dataloader_num_workers = int(2* torch.cuda.device_count())
