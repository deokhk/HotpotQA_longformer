...
from model_util import load_hotpotqa_for_longformer
...
def main():
    ...
    def prepare_train_features(examples):
        ...
        breakpoint()
        context_encodings = tokenizer.encode_plus(examples['context'])

        start_idx, end_idx = get_correct_alignement(examples['context'], examples['answers'])
        start_positions_context = context_encodings.char_to_token(start_idx)
        end_positions_context = context_encodings.char_to_token(end_idx-1)

        start_positions = start_positions_context
        end_positions = end_positions_context
        ...
        tokenized_examples.update({'start_positions': start_positions,
    ...
    def prepare_validation_features(examples):
        ...
        global_attention_mask = list(map(func_global_att, input_ids))
        tokenized_examples.update({"global_attention_mask":global_attention_mask})
        breakpoint()
        return tokenized_examples
