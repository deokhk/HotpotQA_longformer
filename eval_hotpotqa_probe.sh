...
--dataset_name "probe_hotpotqa_original" \
...
--save_total_limit 2 \
--fp16 True \
--run_name longformer_probe_hotpotqa_original_eval_only \
--output_dir /home/deokhk/research/longformer_trained_models/probe_hotpotqa_original_eval_only \
--report_to "wandb" 
